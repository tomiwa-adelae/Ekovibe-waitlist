...
export const CountrySelect = ({
  ...
  return (
    <div className="bg-black border-input/10 text-muted-foreground focus-within:border-ring focus-within:ring-ring/50 hover:bg-black/10 has-aria-invalid:border-destructive/60 has-aria-invalid:ring-destructive/20 dark:has-aria-invalid:ring-destructive/40 relative inline-flex items-center self-stretch rounded-s-md border py-2 ps-3 pe-2 transition-[color,box-shadow] outline-none focus-within:z-10 focus-within:ring-[3px] has-disabled:pointer-events-none has-disabled:opacity-50">
